...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.subjectStream'
        db.add_column(u'basePages_article', 'subjectStream',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['basePages.SubjectStream'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.subjectStream'
        db.delete_column(u'basePages_article', 'subjectStream_id')
