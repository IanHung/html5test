...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PositionInArticle'
        db.create_table(u'basePages_positioninarticle', (
        ...
        db.send_create_signal(u'basePages', ['PositionInArticle'])

        # Adding unique constraint on 'PositionInArticle', fields ['article', 'position']
        db.create_unique(u'basePages_positioninarticle', ['article_id', 'position'])


    def backwards(self, orm):
        # Removing unique constraint on 'PositionInArticle', fields ['article', 'position']
        db.delete_unique(u'basePages_positioninarticle', ['article_id', 'position'])

        # Deleting model 'PositionInArticle'
        db.delete_table(u'basePages_positioninarticle')
