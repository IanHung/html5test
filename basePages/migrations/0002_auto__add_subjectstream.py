...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubjectStream'
        db.create_table(u'basePages_subjectstream', (
        ...
        db.send_create_signal(u'basePages', ['SubjectStream'])


    def backwards(self, orm):
        # Deleting model 'SubjectStream'
        db.delete_table(u'basePages_subjectstream')
